  ...
  mockLogin() {
    this.utilsService.presentActionsheet({
      buttons: [{
        text: 'DUEÑO Lautaro',
        handler: () => {
          this.formLogin.controls.correoLogin.setValue('lautarongalarza@gmail.com');
      ...
      },
      {
        text: 'DUEÑO Axel',
        handler: () => {
          this.formLogin.controls.correoLogin.setValue('axel@axel.com');
          this.formLogin.controls.claveLogin.setValue('123456');
        }
      }, {
        text: 'SUPERVISOR Mathi',
        handler: () => {
      ...
      },
      {
        text: 'Cliente 1',
        handler: () => {
          this.formLogin.controls.correoLogin.setValue('belendamiano@gmail.com');
          this.formLogin.controls.claveLogin.setValue('123456');
        }
      },
      {
        text: 'Cliente 2',
        handler: () => {
          this.formLogin.controls.correoLogin.setValue('axelghio93@gmail.com');
          this.formLogin.controls.claveLogin.setValue('123456');
        }
      },
      {
        ...
        handler: () => {
          this.formLogin.controls.correoLogin.setValue('anonimo@anonimo.com');
          this.formLogin.controls.claveLogin.setValue('123456');
        }
      }, {
        text: 'Cerrar',
